...
/*=========================================================================
  ...
  Module:    $RCSfile: vtkPTemporalRanges.cxx,v $
...
vtkCxxRevisionMacro(vtkPTemporalRanges::vtkRangeTableReduction, "$Revision: 1.1 $");
...
//=============================================================================
//=============================================================================
vtkCxxRevisionMacro(vtkPTemporalRanges, "$Revision: 1.1 $");
