/*=========================================================================
  ...
  Module:    $RCSfile: vtkExtractHistogram.cxx,v $
...
vtkCxxRevisionMacro(vtkExtractHistogramExtentTranslator, "$Revision: 1.6 $");

//-----------------------------------------------------------------------------

vtkCxxRevisionMacro(vtkExtractHistogram, "$Revision: 1.6 $");
