...
vtkCxxRevisionMacro(vtkHyperOctreeInternal, "$Revision: 1.10 $");
...
// vtkCxxRevisionMacro(vtkCompactHyperOctreeCursor, "$Revision: 1.10 $");
...
void vtkCompactHyperOctreeCursor<D>::CollectRevisions(ostream& sos)
{
  ...
  os << "vtkCompactHyperOctreeCursor<" << D <<"> " << "$Revision: 1.10 $" << '\n';
}
...
//vtkCxxRevisionMacro(vtkCompactHyperOctree, "$Revision: 1.10 $");
...
void vtkCompactHyperOctree<D>::CollectRevisions(ostream& sos)
{
  vtkOStreamWrapper os(sos);
  this->Superclass::CollectRevisions(os);
  os << "vtkCompactHyperOctree<" << D <<"> " << "$Revision: 1.10 $" << '\n';
}
...
vtkCxxRevisionMacro(vtkHyperOctree, "$Revision: 1.10 $");
