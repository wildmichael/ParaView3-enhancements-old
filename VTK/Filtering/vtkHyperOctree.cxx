...
vtkCxxRevisionMacro(vtkHyperOctreeInternal, "$Revision: 1.21 $");
...
// vtkCxxRevisionMacro(vtkCompactHyperOctreeCursor, "$Revision: 1.21 $");
...
void vtkCompactHyperOctreeCursor<D>::CollectRevisions(ostream& sos)
{
  ...
  os << "vtkCompactHyperOctreeCursor<" << D <<"> " << "$Revision: 1.21 $" << '\n';
}
...
//vtkCxxRevisionMacro(vtkCompactHyperOctree, "$Revision: 1.21 $");
...
void vtkCompactHyperOctree<D>::CollectRevisions(ostream& sos)
{
  vtkOStreamWrapper os(sos);
  this->Superclass::CollectRevisions(os);
  os << "vtkCompactHyperOctree<" << D <<"> " << "$Revision: 1.21 $" << '\n';
}
...
vtkCxxRevisionMacro(vtkHyperOctree, "$Revision: 1.21 $");
