...
vtkCxxRevisionMacro(vtkHyperOctreeInternal, "$Revision: 1.9 $");
...
// vtkCxxRevisionMacro(vtkCompactHyperOctreeCursor, "$Revision: 1.9 $");
...
void vtkCompactHyperOctreeCursor<D>::CollectRevisions(ostream& sos)
{
  ...
  os << "vtkCompactHyperOctreeCursor<" << D <<"> " << "$Revision: 1.9 $" << '\n';
}
...
//vtkCxxRevisionMacro(vtkCompactHyperOctree, "$Revision: 1.9 $");
...
void vtkCompactHyperOctree<D>::CollectRevisions(ostream& sos)
{
  vtkOStreamWrapper os(sos);
  this->Superclass::CollectRevisions(os);
  os << "vtkCompactHyperOctree<" << D <<"> " << "$Revision: 1.9 $" << '\n';
}
...
vtkCxxRevisionMacro(vtkHyperOctree, "$Revision: 1.9 $");
