...
vtkCxxRevisionMacro(vtkVolumeShearWarpMapper, "$Revision: 1.5 $");
vtkCxxRevisionMacro(vtkShearWarpBase,"$Revision: 1.5 $");
vtkCxxRevisionMacro(vtkShearWarpOctree<unsigned char>,"$Revision: 1.5 $");
vtkCxxRevisionMacro(vtkShearWarpOctree<unsigned short>,"$Revision: 1.5 $");
