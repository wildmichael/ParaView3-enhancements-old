...
vtkCxxRevisionMacro(vtkLabelHierarchyFrustumIterator,"$Revision: 1.30 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyFullSortIterator,"$Revision: 1.30 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyQuadtreeIterator,"$Revision: 1.30 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy3DepthFirstIterator,"$Revision: 1.30 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy,"$Revision: 1.30 $");
