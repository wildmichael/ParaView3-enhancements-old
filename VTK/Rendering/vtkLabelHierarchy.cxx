...
vtkCxxRevisionMacro(vtkLabelHierarchyFrustumIterator,"$Revision: 1.14 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyFullSortIterator,"$Revision: 1.14 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy,"$Revision: 1.14 $");
