...
vtkCxxRevisionMacro(vtkLabelHierarchyFrustumIterator,"$Revision: 1.1 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyFullSortIterator,"$Revision: 1.1 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy,"$Revision: 1.1 $");
