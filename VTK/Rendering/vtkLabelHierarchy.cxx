...
vtkCxxRevisionMacro(vtkLabelHierarchyFrustumIterator,"$Revision: 1.16 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyFullSortIterator,"$Revision: 1.16 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy,"$Revision: 1.16 $");
