...
vtkCxxRevisionMacro(vtkLabelHierarchyFrustumIterator,"$Revision: 1.12 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyFullSortIterator,"$Revision: 1.12 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy,"$Revision: 1.12 $");
