...
vtkCxxRevisionMacro(vtkLabelHierarchyFrustumIterator,"$Revision: 1.8 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyFullSortIterator,"$Revision: 1.8 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy,"$Revision: 1.8 $");
