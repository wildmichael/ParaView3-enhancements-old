...
vtkCxxRevisionMacro(vtkLabelHierarchyFrustumIterator,"$Revision: 1.24 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyFullSortIterator,"$Revision: 1.24 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy,"$Revision: 1.24 $");
