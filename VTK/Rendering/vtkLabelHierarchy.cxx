...
vtkCxxRevisionMacro(vtkLabelHierarchyFrustumIterator,"$Revision: 1.25 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyFullSortIterator,"$Revision: 1.25 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy,"$Revision: 1.25 $");
