...
vtkCxxRevisionMacro(vtkLabelHierarchyFrustumIterator,"$Revision: 1.32 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyFullSortIterator,"$Revision: 1.32 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyQuadtreeIterator,"$Revision: 1.32 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy3DepthFirstIterator,"$Revision: 1.32 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy,"$Revision: 1.32 $");
