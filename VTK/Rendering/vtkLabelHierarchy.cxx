...
vtkCxxRevisionMacro(vtkLabelHierarchyFrustumIterator,"$Revision: 1.3 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyFullSortIterator,"$Revision: 1.3 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy,"$Revision: 1.3 $");
