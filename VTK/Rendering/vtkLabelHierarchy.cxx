...
vtkCxxRevisionMacro(vtkLabelHierarchyFrustumIterator,"$Revision: 1.22 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyFullSortIterator,"$Revision: 1.22 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy,"$Revision: 1.22 $");
