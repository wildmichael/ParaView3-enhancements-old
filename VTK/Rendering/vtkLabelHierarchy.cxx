...
vtkCxxRevisionMacro(vtkLabelHierarchyFrustumIterator,"$Revision: 1.2 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchyFullSortIterator,"$Revision: 1.2 $");
...
vtkCxxRevisionMacro(vtkLabelHierarchy,"$Revision: 1.2 $");
