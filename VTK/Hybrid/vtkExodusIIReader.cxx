...
vtkCxxRevisionMacro(vtkExodusIIReaderPrivate,"$Revision: 1.1 $");
...
vtkCxxRevisionMacro(vtkExodusIIXMLParser,"$Revision: 1.1 $");

// -------------------------------------------------------- PUBLIC CLASS MEMBERS

vtkCxxRevisionMacro(vtkExodusIIReader,"$Revision: 1.1 $");
