...
vtkCxxRevisionMacro(vtkExodusIIReaderPrivate,"$Revision: 1.9 $");
...
vtkCxxRevisionMacro(vtkExodusIIXMLParser,"$Revision: 1.9 $");

// -------------------------------------------------------- PUBLIC CLASS MEMBERS

vtkCxxRevisionMacro(vtkExodusIIReader,"$Revision: 1.9 $");
