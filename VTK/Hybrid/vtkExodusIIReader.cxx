...
vtkCxxRevisionMacro(vtkExodusIIReaderPrivate,"$Revision: 1.3 $");
...
vtkCxxRevisionMacro(vtkExodusIIXMLParser,"$Revision: 1.3 $");

// -------------------------------------------------------- PUBLIC CLASS MEMBERS

vtkCxxRevisionMacro(vtkExodusIIReader,"$Revision: 1.3 $");
