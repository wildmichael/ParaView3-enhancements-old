...
vtkCxxRevisionMacro(vtkExodusIIReaderPrivate,"$Revision: 1.16 $");
...
vtkCxxRevisionMacro(vtkExodusIIXMLParser,"$Revision: 1.16 $");

// -------------------------------------------------------- PUBLIC CLASS MEMBERS

vtkCxxRevisionMacro(vtkExodusIIReader,"$Revision: 1.16 $");
