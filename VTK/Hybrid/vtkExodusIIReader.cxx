...
vtkCxxRevisionMacro(vtkExodusIIReaderPrivate,"$Revision: 1.10 $");
...
vtkCxxRevisionMacro(vtkExodusIIXMLParser,"$Revision: 1.10 $");

// -------------------------------------------------------- PUBLIC CLASS MEMBERS

vtkCxxRevisionMacro(vtkExodusIIReader,"$Revision: 1.10 $");
