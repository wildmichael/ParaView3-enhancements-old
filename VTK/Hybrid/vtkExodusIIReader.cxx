...
vtkCxxRevisionMacro(vtkExodusIIReaderPrivate,"$Revision: 1.8 $");
...
vtkCxxRevisionMacro(vtkExodusIIXMLParser,"$Revision: 1.8 $");

// -------------------------------------------------------- PUBLIC CLASS MEMBERS

vtkCxxRevisionMacro(vtkExodusIIReader,"$Revision: 1.8 $");
