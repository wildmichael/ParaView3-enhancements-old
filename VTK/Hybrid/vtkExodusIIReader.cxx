...
vtkCxxRevisionMacro(vtkExodusIIReaderPrivate,"$Revision: 1.12 $");
...
vtkCxxRevisionMacro(vtkExodusIIXMLParser,"$Revision: 1.12 $");

// -------------------------------------------------------- PUBLIC CLASS MEMBERS

vtkCxxRevisionMacro(vtkExodusIIReader,"$Revision: 1.12 $");
