...
vtkCxxRevisionMacro(vtkExodusIIReaderPrivate,"$Revision: 1.15 $");
...
vtkCxxRevisionMacro(vtkExodusIIXMLParser,"$Revision: 1.15 $");

// -------------------------------------------------------- PUBLIC CLASS MEMBERS

vtkCxxRevisionMacro(vtkExodusIIReader,"$Revision: 1.15 $");
