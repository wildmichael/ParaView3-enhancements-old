...
vtkCxxRevisionMacro(vtkExodusIIReaderPrivate,"$Revision: 1.7 $");
...
vtkCxxRevisionMacro(vtkExodusIIXMLParser,"$Revision: 1.7 $");

// -------------------------------------------------------- PUBLIC CLASS MEMBERS

vtkCxxRevisionMacro(vtkExodusIIReader,"$Revision: 1.7 $");
