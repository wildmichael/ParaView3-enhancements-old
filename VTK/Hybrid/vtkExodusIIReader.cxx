...
vtkCxxRevisionMacro(vtkExodusIIReaderPrivate,"$Revision: 1.2 $");
...
vtkCxxRevisionMacro(vtkExodusIIXMLParser,"$Revision: 1.2 $");

// -------------------------------------------------------- PUBLIC CLASS MEMBERS

vtkCxxRevisionMacro(vtkExodusIIReader,"$Revision: 1.2 $");
